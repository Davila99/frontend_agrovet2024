  ...
  const agronomos = [
    {
      ...
      image: 'https://icones.pro/wp-content/uploads/2022/07/icones-d-administration-orange.png',
    },
    {
      id: '2',
  ...
  const renderItem = ({ item }) => (
    <TouchableOpacity style={styles.agronomistContainer}>
      ...
      <View style={styles.agronomistInfo}>
        ...
        <Text style={styles.agronomistLocation}>Ubicación: {item.location}</Text>
        <Text style={styles.agronomistExperience}>Años de experiencia: {item.experience}</Text>
      </View>
